...
```
/app> ./build.sh (--debug/--release) (--major/--minor/--patch)
```
...
and automatically updates xcode proxy project.

## Update Android API (SDK/NDK)
...
Update NDK via sdkmanager

```
sdkmanager "ndk;28.2.13676358"
```

Update buildozer project after new NDK config
