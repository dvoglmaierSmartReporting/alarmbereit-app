...
INPUT_DIR = Path("./app/assets/hallein_leiter_original")
OUTPUT_DIR = Path("./app/assets/hallein_leiter")
INPUT_DIR = Path("./app/assets/tools_original")
OUTPUT_DIR = Path("./app/assets/tools")
